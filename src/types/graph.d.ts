...
export interface Mutation {
  ...
  ModifyDrivingStatus: ModifyDrivingStatusResponse;
...
export interface ModifyDrivingStatusMutationArgs {
...
export interface ModifyDrivingStatusResponse {
  ok: boolean;
  error: string | null;
}
