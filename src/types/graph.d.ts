...
export interface Mutation {
  ...
  ModifyDriverModeOn: ModifyDriverModeOnResponse;
...
export interface ModifyDriverModeOnMutationArgs {
  driverModeOn: boolean;
}
...
export interface ModifyDriverModeOnResponse {
  ok: boolean;
  error: string | null;
}
