        ...
        RideStatusSubscription: {
            subscribe: graphql_yoga_1.withFilter(function (_, __, _a) {
                ...
                return __awaiter(void 0, void 0, void 0, function () {
                    var user, _b, driverId, passengerId;
                    return __generator(this, function (_c) {
                        user = context.currentUser;
                        _b = payload.RideStatusSubscription, driverId = _b.driverId, passengerId = _b.passengerId;
                        return [2 /*return*/, (user.id === driverId || user.id === passengerId)];
                    });
                });
            })
        }
