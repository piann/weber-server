...
var resolvers = {
    Mutation: {
        ModifyDrivingStatus: privateResolver_1.default(function (_, args, _a) {
            var req = _a.req;
            return __awaiter(void 0, void 0, void 0, function () {
                var user, driverModeOn, isDriving, error_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            driverModeOn = user.driverModeOn, isDriving = user.isDriving;
                            ...
                            return [4 /*yield*/, User_1.default.update({ id: user.id }, __assign(__assign({}, user), { driverModeOn: driverModeOn, isDriving: isDriving }))];
                        case 2:
                            _b.sent();
                            return [2 /*return*/, {
                                    ok: true,
...
//# sourceMappingURL=ModifyDriverModeOn.resolvers.js.map