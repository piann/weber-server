            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.trys.push([1, 5, , 6]);
                            return [4 /*yield*/, Verification_1.default.findOne({ payload: user.email })];
                        case 2:
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, sendEmail_1.sendVerificationEmail(user.email, user.fullName, newVerification.key)];
                        case 4:
                            _b.sent();
                            return [2 /*return*/, {
                                    ok: true,
                        ...
                        case 7: return [2 /*return*/, {
                                ok: false,
                                error: "Your user has no email or It is already verified"
                            }];
