                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            user = req.user;
                            key = args.key;
                            if (!user.email) return [3 /*break*/, 8];
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 6, , 7]);
                            return [4 /*yield*/, Verification_1.default.findOne({ key: key, payload: user.email })];
                        case 2:
                            verification = _b.sent();
                            if (!verification) return [3 /*break*/, 4];
                            ...
                            return [4 /*yield*/, User_1.default.update({ id: user.id }, __assign(__assign({}, user), { verifiedEmail: true }))];
                        case 3:
                            _b.sent();
                            return [2 /*return*/, {
                                    ok: true,
