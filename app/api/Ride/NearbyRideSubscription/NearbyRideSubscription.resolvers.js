        ...
        NearbyRideSubscription: {
            subscribe: graphql_yoga_1.withFilter(function (_, __, _a) {
                ...
                return __awaiter(_this, void 0, void 0, function () {
                    var user, _b, pickUpLat, pickUpLng, driverLastLat, driverLastLng;
                    return __generator(this, function (_c) {
                        user = context.currentUser;
                        _b = payload.NearbyRideSubscription, pickUpLat = _b.pickUpLat, pickUpLng = _b.pickUpLng;
                        driverLastLat = user.lastLat, driverLastLng = user.lastLng;
                        return [2 /*return*/, (pickUpLat >= driverLastLat - 0.05 &&
