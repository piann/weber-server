        ...
        EmailSignUp: function (_, args) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2: return [4 /*yield*/, Verification_1.default.findOne({
                            payload: args.phoneNumber, verified: true
                        })];
                    case 3:
                        phoneVerification = _a.sent();
                        if (!phoneVerification) return [3 /*break*/, 8];
                        return [4 /*yield*/, User_1.default.create(__assign({}, args)).save()];
                    case 4:
                        newUser = _a.sent();
                        if (!newUser.email) return [3 /*break*/, 7];
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, sendEmail_1.sendVerificationEmail(newUser.email, newUser.fullName, emailVerification.key)];
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7:
